...
"""Realised-uplift target ft module."""
...
def apply_ft_target_realised_uplift(frame: pd.DataFrame) -> pd.DataFrame:
    """Add realized uplift versus the explicit baseline demand."""
